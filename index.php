    ...
    <section class="row no-gutters home-contact" style="position: relative; overflow: hidden;">
        ...
        <div class="container mx-auto">
            <div class="row">
                ...
                <div class="col-md">
                    <div class="row">
                        <div class="col-md-12" id="linkedin" style="background: lightskyblue;" onclick="location.href='https://www.linkedin.com/in/steven-gardiner/'">
                            <div class="mx-auto" style="background-image:url('resources/img/linkedin-logo.png')"></div>
                        </div>
                        <div class="col-md-6" id="github" style="background: #ffffff;" onclick="location.href='https://github.com/stevegardiner26'">
                            <div class="mx-auto" style="background-image:url('resources/img/GitHub_Logo.png')"></div>
                        </div>
                        <div class="col-md-6" id="upwork" style="background: lightgreen;" onclick="location.href='https://www.upwork.com/o/profiles/users/_~01604c87965b6a6f64/'">
                            <div class="mx-auto" style="background-image:url('resources/img/upwork.png')"></div>
                        </div>
                        <div class="col-md-6" id="misc" style="background: #F77A62;">
                            <div class="mx-auto" style="background-image:url('resources/img/99.png')"></div>
                        </div>
                        <div class="col-md-6" id="email" style="background: white; padding: 20px 10px;">
                            <a href="mailto:stevegardiner26@gmail.com?Subject=Web%20Development%20Work">
        ...
        <div class="container-fluid text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a style="margin-left: 45px;" href="mailto:stevegardiner26@gmail.com?Subject=Web%20Development%20Work" target="_top">Click Here to Email Me!</a>
                        </li>
                    </ul>
                </div>
                <!-- Grid column -->
